...
基于你的网络配置（IP: 192.168.76.131），这是一个简化的单节点部署方案。
...
### 3. 访问服务
- **应用地址**: http://192.168.76.131
- **监控地址**: http://192.168.76.131:9090
- **仪表板**: http://192.168.76.131:3000
- **GitLab**: http://192.168.76.131
- **Jenkins**: http://192.168.76.131:8080
- **Harbor**: http://192.168.76.131
